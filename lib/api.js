...
module.exports = function (params, callback) {
    ...
    router.post('/api/attendance/:tid', function (req, res) {
            ...
            floatPersistence.set(
                ...
                nodebb.Plugins.hooks.fire('action:attendance.set', dataSet, noop);
        ...
        Promise.all([
            ...
            getUsersWithFields(currentUser, attendants, function (err, users) {
                ...
                attendants.forEach(function (attendant) {
                    ...
                    attendant.username = u.username;
                    attendant.userslug = u.userslug;
                    attendant.picture = u.picture;
                    attendant['icon:bgColor'] = u['icon:bgColor'];
                    attendant['icon:text'] = u['icon:text'];
                });
                attendants.forEach(function (attendant) {
