...
module.exports = function (params, meta, callback) {
    ...
    const renderEvents = async function (req, res, next) {
        try {
            ...
            const eventsCategories = uniq(Object.getOwnPropertyNames(permissionSettings).reduce((prev, cur) => {
            ...
            const data = await nodebb.Plugins.hooks.fire('filter:events.topics.get', {topics: topics, uid: req.uid});
            res.locals.metaTags = [
                {
                    property: 'og:url',
